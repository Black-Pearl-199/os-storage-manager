...
import logoMedium from "../../assets/images/logo.png";
...
function ClosableTitle(key, title, onClose) {
    return (
        <OverlayTrigger
            placement={"bottom"}
            overlay={
                <Tooltip style={{ wordWrap: "break-word" }}>{title}</Tooltip>
            }
        >
...
const enhance = compose(
    withRouter,
    connect(mapStateToProps, { userLogout, registerResource }),
    translate
);
