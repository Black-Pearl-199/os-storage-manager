...
import { storage_tag_edit } from "../../../data-test";
...
class EditStorageTag extends Component {
    render = () => {
                ...
                <>
                    <Create {...rest} className="w-100" classes={classes}>
                        <SimpleForm
                            ...
                            toolbar={<MySaveToolbar className="px-0" />}
                        >
                            <MyGroupingInput formClassName="col-12 d-flex flex-column hide-legend px-0">
...
export default enhance(EditStorageTag);
